...
model_hash = input("Enter model hash (default: tetrahedron, 'pod' for pod shape): ").strip() or "tetrahedron"
...
# 3D Model Selection
model_func = pod_model if model_hash.lower() == 'pod' else tetrahedron_model
